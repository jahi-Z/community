...
public class UserService implements CommunityConstant {
    ...
    public Map<String, Object> register(User user) {
        ...
        user.setHeaderUrl(String.format("http://images.nowdcoder.com/head/%dt.png", new Random().nextInt(1000)));
        ...
        //http://localhost:8080/community/activation/151/code
    ...
    public Map<String, Object> updatePassword(int userId, String oldPassword, String newPassword1,String newPassword2) {
        ...
        if(!newPassword1.equals(newPassword2)){
            map.put("FirstNoSecondPasswordMsg", "两次输入的密码不一致!");
            return map;
        }
